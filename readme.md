# Road Water Dataset 5200 Images YOLO format electronic data.

# Body

Road Water Dataset, 5200 Images, YOLO format, electronic data.

The images are clear, with complete annotations, suitable for training target detection models related to road waterlogging, ready to use directly, and convenient.
